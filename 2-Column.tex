...
{second part again}
{
    \coloredbox[bgcolor=gray, fgcolor=white, framecolor=bkBG, width=0.5\colwidth-105pt]{Leo in vitae turpis massa. Morbi tristique senectus et netus et malesuada fames. Adipiscing elit ut aliquam purus sit amet luctus venenatis lectus. }
}
\end{multicols*}
}